            ...
            <div class="content mt-4 p-3">
                ...
                <form action="{{ Route('user.store') }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="mb-2">
                        ...
                        <input  required="true" type="text" name="name" id="name" placeholder="Nama Lengkap"
                    ...
                    <div class="mb-2">
                        <label for="policy" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Hak
                            Akses</label>
                        <select required="true" id="policy" name="role"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="mb-2">
                        ...
                        <input  required="true"type="password" placeholder="••••••••" name="password" id="password"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    
                    <div class="mb-2">
                        <label for="password_confirmation" class="block text-gray-700 text-sm mb-2">Konfirmasi
                            Password</label>
                        <input  required="true" type="password" placeholder="••••••••" name="confirm" id="password_confirmation"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
                    <button type="submit"
