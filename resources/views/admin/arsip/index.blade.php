                            ...
                            @else
                                @foreach ($data as $fetch)
                                    <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td>
                                            <a href="{{ route('arsip.show', $fetch->id) }}" class="inline-block px-2 py-1 font-semibold leading-tight text-white transform bg-red-600 rounded-full">
                                            ...
                                            <a href="{{ route('arsip.show', $fetch->id) }}" class="inline-block px-2 py-1 font-semibold leading-tight text-white transform bg-blue-600 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
                                            ...
                                            <a href="{{ route('arsip.show', $fetch->id) }}" class="inline-block px-2 py-1 font-semibold leading-tight text-white transform bg-green-600 rounded-full">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="inline-flex -space-x-px text-sm mt-4">
                        ...
                        @for ($i = 1; $i <= $data->lastPage(); $i++)
                            <li>
                                <a href="{{ $data->url($i) }}" class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white {{ $data->currentPage() == $i ? 'bg-slate-500 text-white' : '' }}">{{ $i }}</a>
                            </li>
                        @endfor
                        <li>
                            <a href="{{ $data->nextPageUrl() }}" class="flex items-center justify-center px-3 h-8 leading-tight text-gray-500 bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Next</a>
                        </li>
                    </ul>
                </nav>
